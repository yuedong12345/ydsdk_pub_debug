...
#import "KSAdViewActionConfiguration.h"
...
/**
 Please prioritize using new methods: registerContainer:withViewActionConfiguration: and registerActionViews:withViewActionConfiguration:
...
/**
 Register container view in native ads view. Need to create KSAdViewActionConfiguration object and set properties' value.
 This method must be called because it has exposure monitoring.
 @param configuration : required.
 */
- (void)registerContainer:(__kindof UIView *)containerView withViewActionConfiguration:(KSAdViewActionConfiguration *)configuration;
/**
 Register clickable views or slidable views in native ads view. Need to create KSAdViewActionConfiguration object and set properties' value.
 @param configuration : required.
 */
- (void)registerActionViews:(NSArray<__kindof UIView *> *_Nullable)actionViews withViewActionConfiguration:(KSAdViewActionConfiguration *)configuration;
/**
