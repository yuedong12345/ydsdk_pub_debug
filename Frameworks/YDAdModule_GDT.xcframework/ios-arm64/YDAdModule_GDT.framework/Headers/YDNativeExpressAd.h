...
#ifndef YDNativeExpressAd_h
#define YDNativeExpressAd_h
...
@protocol YDNativeAdDataObject <NSObject>

- (void)setViewController:(UIViewController *)rootViewCoontroller;
