...
@interface YFComposition : NSObject
...
@property (nonatomic, strong, readonly, nullable) YFLayerGroup *layerGroup;
@property (nonatomic, strong, readonly, nullable) YFAssetGroup *assetGroup;
