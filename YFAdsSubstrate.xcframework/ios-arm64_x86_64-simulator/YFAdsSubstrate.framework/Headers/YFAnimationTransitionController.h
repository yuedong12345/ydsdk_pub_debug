//
//  YFAnimationTransitionController.h
//  Lottie
//
...
/** YFAnimationTransitionController
 *
...
@interface YFAnimationTransitionController : NSObject <UIViewControllerAnimatedTransitioning>
